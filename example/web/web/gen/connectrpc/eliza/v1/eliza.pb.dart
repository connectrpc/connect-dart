...
class ConverseRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConverseRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'connectrpc.eliza.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'sentence')
    ..hasRequiredFields = false
  ;
...
class ConverseResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConverseResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'connectrpc.eliza.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'sentence')
    ..hasRequiredFields = false
  ;
...
class IntroduceRequest extends $pb.GeneratedMessage {
  ...
  factory IntroduceRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory IntroduceRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'IntroduceRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'connectrpc.eliza.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  IntroduceRequest copyWith(void Function(IntroduceRequest) updates) => super.copyWith((message) => updates(message as IntroduceRequest)) as IntroduceRequest;
  ...
  static $pb.PbList<IntroduceRequest> createRepeated() => $pb.PbList<IntroduceRequest>();
  @$core.pragma('dart2js:noInline')
  static IntroduceRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<IntroduceRequest>(create);
...
class IntroduceResponse extends $pb.GeneratedMessage {
  ...
  factory IntroduceResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory IntroduceResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'IntroduceResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'connectrpc.eliza.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'sentence')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  IntroduceResponse copyWith(void Function(IntroduceResponse) updates) => super.copyWith((message) => updates(message as IntroduceResponse)) as IntroduceResponse;
  ...
  static $pb.PbList<IntroduceResponse> createRepeated() => $pb.PbList<IntroduceResponse>();
  @$core.pragma('dart2js:noInline')
  static IntroduceResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<IntroduceResponse>(create);
...
class ElizaServiceApi {
  ...
  $async.Future<ConverseResponse> converse($pb.ClientContext? ctx, ConverseRequest request) =>
    _client.invoke<ConverseResponse>(ctx, 'ElizaService', 'Converse', request, ConverseResponse())
  ;
  $async.Future<IntroduceResponse> introduce($pb.ClientContext? ctx, IntroduceRequest request) =>
    _client.invoke<IntroduceResponse>(ctx, 'ElizaService', 'Introduce', request, IntroduceResponse())
  ;
}
